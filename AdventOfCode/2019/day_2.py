...
if __name__ == "__main__":
    print(process_program(12,2))
    output_needed = 19690720
    for noun,verb in list(permutations(range(100),2)):
        if output_needed == process_program(noun, verb):
            print(noun, verb)